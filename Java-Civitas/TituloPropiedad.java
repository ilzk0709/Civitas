 ...
 * factor de revalorización de la venta, precio base del alquiler, precio base de hipoteca y nombre 
 * de la calle asociada a dicha casilla. El título de propiedad de una casilla es el objeto de las compras y ventas, 
 * de forma que podemos decir que un jugador es “propietario de una casilla” cuando es propietario de su título de propiedad.    
 *
...
public class TituloPropiedad {
     ...
     * parametro no lo es se tramita el pago del alquiler a ese jugador
     * y se ingresa la misma cantidad de saldo en el propietario
    ...
    /**
     * @brief si el jugador pasado como parametro es el propietario del 
     * título y el numero de casas construidas es mayor o igual que el 
     * parametro n, se decrementa el contador de casas construidas en n unidades
     ...
     * y este no esta hipotecado, entonces se da al propietario el precio de venta, 
     * se desvincula el propietario de la propiedad, y se eliminan las casas y hoteles
     * @param jug Instancia de jugador
